    ...
    return(
        <div className="projects-main-container">
            <div className="project-card-container">
                <ProjectCard title="Galaxy Classifier" description="Convolutional Neural Network to galaxy classification by the Hubble Secuence Protocol. Project for final university course." image ="../assets/landingpagedummy.png"/>
