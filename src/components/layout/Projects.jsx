    ...
    return(
        <div className="projects-main-container">
            <div className="project-card-container">
                ...
                <ProjectCard title="Virtual Wallet" description="Basic virtual wallet with login and signin, QR pay method, real time dollar cotizations. Project for System Design university course." badgets={["ruby","react","sqlite","docker"]}/>
                <ProjectCard title="Relational Data Base"  description="tal" badgets={["java","postgresql"]}/>
